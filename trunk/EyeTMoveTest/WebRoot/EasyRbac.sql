...
MySQL - 5.0.85-community-nt : Database - test
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`eyetdbtpl` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `user`(`id`,`username`,`passwd`,`roleid`) values (1,'admin','123',1),(2,'user','user',1),(6,'member2','321123',3);
